    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('faq.store') }}">
            ...
            <div class="form-group">
                ...
                <input name="question" type="text" class="form-control" placeholder="Pertanyaan">
            </div>
            <div class="form-group">
                <label for="name" class="form-label">Jawaban</label>
                <textarea name="answer" type="text" class="form-control"placeholder="Jawab bang"></textarea>
            </div>
