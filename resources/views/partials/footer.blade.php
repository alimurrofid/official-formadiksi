<div class="container text-center text-md-start">
    <div class="row text-center text-md-start">
        <div class="col-xl-3 col-lg-3 col-md-3 mx-auto mt-5 ">
            <h5 class="mb-3">
                <img src="{{ asset('assets/img/formadiksi.png') }}" loading="lazy" alt="Formadiksi Polinema" width="220">
            </h5>
            <p class="desc-forum">
        ...
        <div class="col-xl-3 col-lg-3 col-md-3 mx-auto mt-5 ">
            ...
            <p>
                <iframe
                    ...
                    referrerpolicy="no-referrer-when-downgrade" title="gmaps"></iframe>
            </p>
        </div>
        ...
        <div class="col-xl-2 col-lg-2 col-md-2 mx-auto mt-5 ">
            ...
            <p>
                <a class="footer-title text-decoration-none" href="https://twitter.com/FMDPolinema">Twitter</a>
            </p>
            <p>
                <a class="footer-title text-decoration-none"
            ...
            <p>
                <a class="footer-title text-decoration-none" href="mailto:formadiksipolinema@gmail.com">Email</a>
            </p>
        </div>
    </div>
</div>
